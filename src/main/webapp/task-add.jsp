            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                  ...
                                  <h4 class="page-title">   <c:choose>
        <c:when test="${task != null}">Sửa công việc</c:when>
        <c:otherwise>Thêm mới công việc</c:otherwise>
    </c:choose></h4>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                     <form class="form-horizontal form-material" action="${task != null ? 'task-save-update' : 'task-create'}" method="post">
                                <!-- Select Project (Dự án) -->
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="job_id">
                                              <c:forEach var="job" items="${jobs}">
										        <option value="${job.id}" 
										            <c:if test="${job.id == currentJobId}">selected</c:if>> 
										            ${job.name}
										        </option>
										    </c:forEach>
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="user_id">
										        ...
										        <option value="${user.id}" 
										            <c:if test="${user.id == currentUserId}">selected</c:if>> 
										            ${user.fullname}
										        </option>
										    </c:forEach>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy" class="form-control form-control-line" name="start_date"                   value="${task != null ? task.start_date : ''}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy" class="form-control form-control-line" name="end_date" value="${task != null ? task.end_date : ''}"  >
                                    </div>
                                </div>
                    ...
                    <c:when test="${task != null}">Lưu lại</c:when>
