...
<body>
            ...
            Thêm mới thành viên
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:choose>
                  <c:when test='${user != null}'>user-save-update</c:when>
                  <c:otherwise>user-create</c:otherwise>
                            ...
                            <input type="hidden" name="id" value="${user.id}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Johnathan Doe" value="${user != null ? user.fullname : 'Johnathan Doe'}"
                                            class="form-control form-control-line" name="fullname"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input type="email" placeholder="johnathan@admin.com"  value="${user != null ? user.email : 'johnathan@admin.com'}"
                                            class="form-control form-control-line" 
                                            id="example-email" name="email"> </div>
                                </div>
                                <div class="form-group">
    ...
    <c:if test="${role.id == currentRoleid}">selected</c:if>>
    ${role.description}
</option>
